...
if (isset($_POST['register'])) {
   ...
   $role = 1;
   $mysqli ="INSERT INTO users (username,email,password, id_roles) VALUES (?,?,?,?)";


   $query    = "INSERT INTO users (username,  email, password, id_roles) VALUES ('$username', '$email', '" . md5($password) . "', '$role')";
