...
if (isset($_POST['pesan'])) {
   ...
   $mysqli ="INSERT INTO pesanan (nama,no_hp,alamat,jam) VALUES (?,?,?,jam)";


   $query    = "INSERT INTO pesanan (nama,  no_hp, alamat , jam) VALUES ('$nama', '$hp', '$alamat', '$jam')";
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li><a href="#potongan" class="dropdown-item" class="nav-link">Model & Harga</a></li>
              <li><a href="#pembayaran" class="dropdown-item" class="nav-link">Metode Pembayaran</a></li>
...
<div class="container potongan" id="potongan">
  <h1 class="judul-model">MODEL & HARGA</h1>
  ...
  <div class="row">
    <div class="col-sm">
      ...
      <div class="card-body">
        ...
        <a href="#" class="btn btn-primary">30k-40k</a>
      </div>
      </div>
        </div>
        <div class="col-sm">
      ...
      <div class="row block-9">
        <div class="col-md-6 contact-info ftco-animate fadeInUp ftco-animated">
          ...
          Anda dapat menikmati layanan kami dengan mudah melalui ponsel atau komputer Anda.Kebersihan dan keamanan adalah prioritas utama kami.
           Kami selalu menjaga standar sanitasi yang ketat dalam setiap layanan yang kami berikan. Alat-alat kami selalu dibersihkan dan disterilkan dengan cermat untuk menjaga kebersihan dan kesehatan pelanggan kami. 
          Anda dapat merasa tenang dan nyaman saat menggunakan layanan kami.Terima kasih telah memilih Barbershop Online. Kami sangat bersemangat untuk memberikan pengalaman potong rambut yang tak terlupakan dan melayani Anda dengan sepenuh hati.
        ...
        <div class="col-md-6 ftco-animate fadeInUp ftco-animated">
          <div class="row">
          <img src="assets/img/koko.jpeg" style="width:450px; height:450px; margin-left:50px;" alt="">
